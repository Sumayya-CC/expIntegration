...
export default function SelectIncomeCategory(props) {
  ...
  const handleAdd = event => {
    ...
    console.log("Adding");
    axios.post(`http://localhost:8081/tracker/register/addincomecategory?userId=${props.message}&categoryName=${state.newCategory}`).then(res => {
      console.log("res="+res);
      setOpen1(false);
